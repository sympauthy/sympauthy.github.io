...
| ```login-claims``` | array of string | List of [claim](/documentation/technical/configuration#claims-id) identifiers used as login identifier when authenticating by password.                                                                                                                                                                                                        | NO<br>```[]```           |
