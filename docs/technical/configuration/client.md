...
| ```authorization-flow```               | string          | The identifier of the authorization flow to use for this client. See [authorization flows](/technical/configuration/authorization#flows-id) for more details.                                                                                                                                                                  | **YES**              |
